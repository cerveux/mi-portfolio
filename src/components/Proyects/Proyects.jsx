                                ...
                                return (
                                    <div className="project-card" style={{ backgroundImage: `url(${proyecto.imagen})` }} key={index}>
                                        <div className="blur-card">
                                            ...
                                            <a className="proyect-link" rel="noreferrer" target="_blank" href={proyecto.link} style={{color: color.primario}}>
                                            ...
                                            <p className="proyect-description  inter">{proyecto.titulo}</p>
                                        </div>
                                    </div>
                                )
                            })}
