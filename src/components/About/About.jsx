        ...
        <section className='aboutMe' style={{ backgroundColor: color.secundario }} id="about">
            <div className="about-container container">
                ...
                <div className="about-parrafo">
                    <p style={{ color: color.texto }}>{idioma ? " A Front-End Developer from Córdoba, Argentina. I´m a tech and code enthusiast whose hobbies are learning new things, working out and martial arts." 
                    ...
                    <p style={{ color: color.texto }}>{idioma ? " I started coding as a hobby in the early 2000s making small pc “board” games in Java to play with friends, never as a job thou. " 
                    : " Empecé a programar allá por el año 2003 haciendo juegos de “mesa” en pc en Java para jugar con amigos aunque nunca lo pensé como un posible trabajo."}</p>
